...
configTableRow = (function() {

  function configTableRow() {
    var accountField, accountLabel, baseColor, configRows, fieldTheme, labelTheme, loginBtn, logoutBtn, passwordField, passwordLabel, qiitaColor, row1, row2, row3, rowTheme;
    baseColor = '#ededed';
    qiitaColor = '#4BA503';
    rowTheme = {
      width: 300,
